...
import { Phone, MessageCircle, Calendar, TrendingUp, ArrowRight, Play } from 'lucide-react';
...
const LandingPage: React.FC = () => {
  ...
  const features = [
    { icon: <MessageCircle size={24} />, title: "Answers WhatsApp 24/7", desc: "Customers ask about prices? Amina checks your inventory and replies instantly. Even at 2 AM." },
    { icon: <Calendar size={24} />, title: "Books Appointments", desc: "She checks your calendar and schedules customers. Sends reminders. Reduces no-shows by 80%." },
    { icon: <TrendingUp size={24} />, title: "Speaks Local Languages", desc: "English, Swahili, Yoruba, Pidgin. She understands 'How much?' and 'E get work?'" },
    { icon: <Phone size={24} />, title: "Takes Voice Notes", desc: "Customers send voice messages? She transcribes, understands, and responds. Perfect for busy traders." }
  ];
    ...
    <div style={{
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', gap: '32px', alignItems: 'center' }}>
          ...
          <Link to="/login" style={{ color: '#888', textDecoration: 'none', fontSize: '14px', fontWeight: 500, transition: 'color 0.2s' }} onMouseEnter={e => e.currentTarget.style.color = '#fff'} onMouseLeave={e => e.currentTarget.style.color = '#888'}>Sign In</Link>
          <Link to="/register">
            <button style={{
              padding: '12px 24px',
              background: 'linear-gradient(135deg, #E2725B 0%, #FF8E53 100%)',
            ...
            <div style={{ display: 'flex', gap: '16px', marginBottom: '48px' }}>
              <Link to="/register" style={{ textDecoration: 'none' }}>
                <button style={{
                  ...
                  Hire Amina Now <ArrowRight size={20} />
                </button>
              </Link>
          ...
          <div style={{ 
            ...
            <div style={{
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '12px' }}>
                {['Amina (WhatsApp sales)', '500 conversations/mo', 'Basic inventory tracking', 'Swahili & Pidgin support', 'Email support'].map(feature => (
                  <li key={feature} style={{ fontSize: '14px', color: '#aaa', display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div style={{
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '12px' }}>
                {['Amina + Stan + Eva', 'Unlimited conversations', 'Advanced analytics', 'Priority support', 'Custom AI training'].map(feature => (
                  <li key={feature} style={{ fontSize: '14px', color: '#ccc', display: 'flex', alignItems: 'center', gap: '10px' }}>
                    <span style={{ color: '#4ADE80', fontSize: '16px' }}>✓</span> {feature}
                  </li>
                ))}
              </ul>
          ...
          <div style={{ display: 'flex', gap: '60px' }}>
            <div>
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '10px', fontSize: '14px', color: '#666' }}>
                {['AI Team', 'Pricing', 'Integrations', 'API'].map(item => (
                  <li key={item} style={{ cursor: 'pointer', transition: 'color 0.2s' }} onMouseEnter={e => e.currentTarget.style.color = '#fff'} onMouseLeave={e => e.currentTarget.style.color = '#666'}>{item}</li>
                ))}
              </ul>
            </div>
            <div>
