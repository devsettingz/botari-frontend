    ...
    return (<div style={{
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: '1400px' }}>
        ...
        <div style={{
          ...
          {[
            { icon: <lucide_react_1.MessageCircle size={24}/>, label: 'Total Messages', value: '2,847', trend: '+12%', color: '#4A90FF' },
            { icon: <lucide_react_1.Users size={24}/>, label: 'Conversations', value: '156', trend: '+8%', color: '#E2725B' },
            { icon: <lucide_react_1.TrendingUp size={24}/>, label: 'Conversion Rate', value: '24%', trend: '+5%', color: '#4ADE80' },
            { icon: <lucide_react_1.BarChart3 size={24}/>, label: 'Avg Response', value: '1.2s', trend: '-0.3s', color: '#9B59B6' }
