        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            color: '#fff'
                ...
                <lucide_react_1.Mail size={14} color="#E2725B"/>
                Email Address
              </label>
              <input type="email" placeholder="john@company.com" value={email} onChange={(e) => setEmail(e.target.value)} required style={{
            width: '100%',
            padding: '14px 16px',
            ...
            color: '#fff'
                ...
                <lucide_react_1.Lock size={14} color="#E2725B"/>
                Password
              </label>
            ...
            cursor: 'pointer'
                ...
                <input type="checkbox" checked={rememberMe} onChange={() => setRememberMe(!rememberMe)} style={{
            width: '16px',
            height: '16px',
            accentColor: '#E2725B',
            cursor: 'pointer'
